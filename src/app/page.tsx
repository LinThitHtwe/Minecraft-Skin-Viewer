...
export default function Home() {
	...
	return (
		<>
			<div className="grid  lg:grid-cols-2 py-6 items-stretch px-4 lg:px-10 xl:px-28 gap-6  ">
				<div className="border-2 border-card-border bg-card-background rounded-2xl p-4">
					...
					<p className="text-black text-lg border-b border-card-border pb-1 font-medium mb-4">
						Configure
					</p>
					<div className="mb-4 flex gap-5">
						<div className="w-fit">
							...
							<input
								type="text"
								id="fov"
								className="bg-gray-50 border focus:outline-none  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-btn-primary focus:border-btn-primary block w-20 p-2.5"
								placeholder="75"
					...
					<div className="flex items-center gap-2 mb-6">
						...
						<input
							...
							className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-btn-primary focus:border-btn-primary block w-14 p-2.5"
						/>
